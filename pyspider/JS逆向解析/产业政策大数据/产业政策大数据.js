...
!function (g) {
    ...
    r = {
        ...
        11: [function (e, t, n) {
            ...
            n.fromObject = function (e) {
                ...
                for (var s = 0; s < t.length; ++s) {
                    var a = t[s].resolve()
                        , c = r.safeProp(a.name);
                    a.map ? (n("if(d%s){", c)('if(typeof d%s!=="object")', c)("throw TypeError(%j)", a.fullName + ": object expected")("m%s={}", c)("for(var ks=Object.keys(d%s),i=0;i<ks.length;++i){", c),
                        i(n, a, s, c + "[ks[i]]")("}")("}")) : a.repeated ? (n("if(d%s){", c)("if(!Array.isArray(d%s))", c)("throw TypeError(%j)", a.fullName + ": array expected")("m%s=[]", c)("for(var i=0;i<d%s.length;++i){", c),
                        i(n, a, s, c + "[i]")("}")("}")) : (a.resolvedType instanceof o || n("if(d%s!=null){", c),
                        i(n, a, s, c),
                ...
                n.toObject = function (e) {
                    ...
                    for (var n = r.codegen(["m", "o"], e.name + "$toObject")("if(!o)")("o={}")("var d={}"), i = [], a = [], c = [], l = 0; l < t.length; ++l)
                        t[l].partOf || (t[l].resolve().repeated ? i : t[l].map ? a : c).push(t[l]);
                    if (i.length) {
                    ...
                    for (l = 0; l < t.length; ++l) {
                        ...
                        d.map ? (p || (p = !0,
                            ...
                            s(n, d, h, f + "[ks2[j]]")("}")) : d.repeated ? (n("if(m%s&&m%s.length){", f, f)("d%s=[]", f)("for(var j=0;j<m%s.length;++j){", f),
                            s(n, d, h, f + "[j]")("}")) : (n("if(m%s!=null&&m.hasOwnProperty(%j)){", f, d.name),
                            s(n, d, h, f),
        ...
        12: [function (e, t, n) {
            t.exports = function (e) {
                ...
                for (var n = 0; n < e.fieldsArray.length; ++n) {
                    var s = e.i[n].resolve()
                        , a = s.resolvedType instanceof o ? "int32" : s.type
                        , c = "m" + i.safeProp(s.name);
                    t("case %i:", s.id),
                        s.map ? (t("if(%s===util.emptyObject)", c)("%s={}", c)("var c2 = r.uint32()+r.pos"),
                            r.defaults[s.keyType] !== g ? t("k=%j", r.defaults[s.keyType]) : t("k=null"),
                            r.defaults[a] !== g ? t("value=%j", r.defaults[a]) : t("value=null"),
                            t("while(r.pos<c2){")("var tag2=r.uint32()")("switch(tag2>>>3){")("case 1: k=r.%s(); break", s.keyType)("case 2:"),
                            r.basic[a] === g ? t("value=types[%i].decode(r,r.uint32())", n) : t("value=r.%s()", a),
                            t("break")("default:")("r.skipType(tag2&7)")("break")("}")("}"),
                            r.long[s.keyType] !== g ? t('%s[typeof k==="object"?util.longToHash(k):k]=value', c) : t("%s[k]=value", c)) : s.repeated ? (t("if(!(%s&&%s.length))", c, c)("%s=[]", c),
                        r.packed[a] !== g && t("if((t&7)===2){")("var c2=r.uint32()+r.pos")("while(r.pos<c2)")("%s.push(r.%s())", c, a)("}else"),
                            r.basic[a] === g ? t(s.resolvedType.group ? "%s.push(types[%i].decode(r))" : "%s.push(types[%i].decode(r,r.uint32()))", c, n) : t("%s.push(r.%s())", c, a)) : r.basic[a] === g ? t(s.resolvedType.group ? "%s=types[%i].decode(r)" : "%s=types[%i].decode(r,r.uint32())", c, n) : t("%s=r.%s()", c, a),
                        t("break")
                }
        ...
        13: [function (e, t, n) {
            t.exports = function (e) {
                for (var t, n = i.codegen(["m", "w"], e.name + "$encode")("if(!w)")("w=Writer.create()"), a = e.fieldsArray.slice().sort(i.compareFieldsById), c = 0; c < a.length; ++c) {
                    var l = a[c].resolve()
                        , u = e.i.indexOf(l)
                    ...
                    t = "m" + i.safeProp(l.name),
                        l.map ? (n("if(%s!=null&&Object.hasOwnProperty.call(m,%j)){", t, l.name)("for(var ks=Object.keys(%s),i=0;i<ks.length;++i){", t)("w.uint32(%i).fork().uint32(%i).%s(ks[i])", (l.id << 3 | 2) >>> 0, 8 | r.mapKey[l.keyType], l.keyType),
                            ...
                            l.packed && r.packed[d] !== g ? n("w.uint32(%i).fork()", (l.id << 3 | 2) >>> 0)("for(var i=0;i<%s.length;++i)", t)("w.%s(%s[i])", d, t)("w.ldelim()") : (n("for(var i=0;i<%s.length;++i)", t),
                                f === g ? s(n, l, u, t + "[i]") : n("w.uint32(%i).%s(%s[i])", (l.id << 3 | f) >>> 0, d, t)),
                            n("}")) : (l.optional && n("if(%s!=null&&Object.hasOwnProperty.call(m,%j))", t, l.name),
                            f === g ? s(n, l, u, t) : n("w.uint32(%i).%s(%s)", (l.id << 3 | f) >>> 0, d, t))
                }
                return n("return w")
            }
            ;
        ...
        14: [function (e, t, n) {
            ...
            s.fromJSON = function (e, t) {
                return (e = new s(e, t.values, t.options, t.comment, t.comments)).reserved = t.reserved,
                    e
            }
                ,
        ...
        15: [function (e, t, n) {
            ...
            var r, i = e(14), s = e(32), a = e(33), c = /^required|optional|repeated$/;

            function l(e, t, n, r, i, l, u) {
                if (a.isObject(r) ? (u = i,
                    l = r,
                    r = i = g) : a.isObject(i) && (u = l,
                    l = i,
                    i = g),
                    o.call(this, e, l),
                !a.isInteger(t) || t < 0)
            ...
            l.fromJSON = function (e, t) {
                ...
                l.prototype.toJSON = function (e) {
                    return e = !!e && !!e.keepComments,
                        a.toObject(["rule", "optional" !== this.rule && this.rule || g, "type", this.type, "id", this.id, "extend", this.extend, "options", this.options, "comment", e ? this.comment : g])
                }
                ,
                l.prototype.resolve = function () {
                    return this.resolved ? this : ((this.typeDefault = s.defaults[this.type]) === g && (this.resolvedType = (this.declaringField || this).parent.lookupTypeOrEnum(this.type),
                    ...
                    Object.keys(this.options).length || (this.options = g)),
                        this.long ? (this.typeDefault = a.Long.fromNumber(this.typeDefault, "u" == (this.type[0] || "")),
                        Object.freeze && Object.freeze(this.typeDefault)) : this.bytes && "string" == typeof this.typeDefault && (a.base64.test(this.typeDefault) ? a.base64.decode(this.typeDefault, e = a.newBuffer(a.base64.length(this.typeDefault)), 0) : a.utf8.write(this.typeDefault, e = a.newBuffer(a.utf8.length(this.typeDefault)), 0),
                            this.typeDefault = e),
                        this.map ? this.defaultValue = a.emptyObject : this.repeated ? this.defaultValue = a.emptyArray : this.defaultValue = this.typeDefault,
                ...
                l.d = function (e, t, n, o) {
                    return "function" == typeof t ? t = a.decorateType(t).name : t && "object" == typeof t && (t = a.decorateEnum(t).name),
                        function (r, i) {
                            a.decorateType(r.constructor).add(new l(i, e, t, n, {
                                default: o
                            }))
                        }
                }
            ...
            s.fromJSON = function (e, t) {
                ...
                s.d = function (e, t, n) {
                    return "function" == typeof n ? n = i.decorateType(n).name : n && "object" == typeof n && (n = i.decorateEnum(n).name),
                        function (o, r) {
                            i.decorateType(o.constructor).add(new s(r, e, t, n))
                        }
                }
        }
            , {
        ...
        20: [function (e, t, n) {
            ...
            function i(e, t, n, i, s, a, c, l, u) {
                if (r.isObject(s) ? (c = s,
                    s = a = g) : r.isObject(a) && (c = a,
                    a = g),
                t !== g && !r.isString(t))
                    throw TypeError("type must be a string");
                if (!r.isString(n))
                ...
                o.call(this, e, c),
                    this.type = t || "rpc",
                    this.requestType = n,
                    this.requestStream = !!s || g,
                    this.responseType = i,
                    this.responseStream = !!a || g,
        ...
        21: [function (e, t, n) {
            ...
            u.fromJSON = function (e, t) {
                ...
                u.prototype.addJSON = function (e) {
                    if (e)
                        for (var t, n = Object.keys(e), o = 0; o < n.length; ++o)
                            t = e[n[o]],
                                this.add((t.fields !== g ? r : t.values !== g ? s : t.methods !== g ? i : t.id !== g ? a : u).fromJSON(n[o], t));
                    return this
                }
                ,
                ...
                u.prototype.add = function (e) {
                    if (!(e instanceof a && e.extend !== g || e instanceof r || e instanceof s || e instanceof i || e instanceof u))
        ...
        22: [function (e, t, n) {
            ...
            Object.defineProperties(i.prototype, {
                ...
                i.prototype.setParsedOption = function (e, t, n) {
                    ...
                    var o, i, s = this.parsedOptions;
                    return n ? (i = s.find((function (t) {
            ...
            s.fromJSON = function (e, t) {
                ...
                s.d = function () {
                    for (var e = Array(arguments.length), t = 0; t < arguments.length;)
                        e[t] = arguments[t++];
                    return function (t, n) {
                        i.decorateType(t.constructor).add(new s(n, e)),
        ...
        24: [function (e, t, n) {
            t.exports = c;
            var o, r = e(35), i = r.LongBits, s = r.utf8;
        ...
        26: [function (e, t, n) {
            ...
            var r, i, s, a = e(15), c = e(14), l = e(23), u = e(33);
            ...
            d.fromJSON = function (e, t) {
                ...
                d.prototype.load = function e(t, n, o) {
                    ...
                    function l(e) {
                        ...
                        return -1 < t && (t = e.substring(t)) in s ? t : null
                    }
                    ...
                    function d(e, t) {
                        try {
                            if (u.isString(t) && "{" == (t[0] || "") && (t = JSON.parse(t)),
                                ...
                                var o, s = i(t, r, n), d = 0;
                                if (s.imports)
                                    for (; d < s.imports.length; ++d)
                                        (o = l(s.imports[d]) || r.resolvePath(e, s.imports[d])) && p(o);
                                if (s.weakImports)
                                    for (d = 0; d < s.weakImports.length; ++d)
                                        (o = l(s.weakImports[d]) || r.resolvePath(e, s.weakImports[d])) && p(o, !0)
                            } else
            ...
            function h(e, t) {
                ...
                if (n) {
                    var o = new a(t.fullName, t.id, t.type, t.rule, g, t.options);
        ...
        29: [function (e, t, n) {
            ...
            ((r.prototype = Object.create(o.EventEmitter.prototype)).constructor = r).prototype.rpcCall = function e(t, n, r, i, s) {
                if (!i)
                    throw TypeError("request must be specified");
                var a = this;
                if (!s)
                    return o.asPromise(e, a, t, n, r, i);
                if (!a.rpcImpl)
        ...
        30: [function (e, t, n) {
            ...
            a.fromJSON = function (e, t) {
                ...
                a.prototype.create = function (e, t, n) {
                    for (var o, r = new s.Service(e, t, n), a = 0; a < this.methodsArray.length; ++a) {
                        var c = i.lcFirst((o = this.f[a]).resolve().name).replace(/[^$\w_]/g, "");
            ...
            Object.defineProperties(y.prototype, {
                ...
                y.fromJSON = function (e, t) {
                    ...
                    for (var l = Object.keys(t.fields), u = 0; u < l.length; ++u)
                        n.add((void 0 !== t.fields[l[u]].keyType ? a : s).fromJSON(l[u], t.fields[l[u]]));
                    if (t.oneofs)
                    ...
                    if (t.nested)
                        for (l = Object.keys(t.nested),
                                 u = 0; u < l.length; ++u) {
                            var d = t.nested[l[u]];
                            n.add((d.id !== g ? s : d.fields !== g ? y : d.values !== g ? r : d.methods !== g ? c : o).fromJSON(l[u], d))
                        }
        ...
        33: [function (e, t, n) {
            var o, r, i = t.exports = e(35), s = e(27);
            i.codegen = e(3),
                i.fetch = e(5),
                i.path = e(8),
                i.fs = i.inquire("fs"),
            ...
            i.decorateEnum = function (t) {
                ...
                Object.defineProperty(i, "decorateRoot", {
                    get: function () {
                        return s.decorated || (s.decorated = new (e(26)))
                    }
                })
        }
            , {
        ...
        34: [function (e, t, n) {
            ...
            r.fromHash = function (e) {
                return "\0\0\0\0\0\0\0\0" === e ? i : new r((s.call(e, 0) | s.call(e, 1) << 8 | s.call(e, 2) << 16 | s.call(e, 3) << 24) >>> 0, (s.call(e, 4) | s.call(e, 5) << 8 | s.call(e, 6) << 16 | s.call(e, 7) << 24) >>> 0)
            }
                ,
        ...
        35: [function (e, t, n) {
            ...
            o.asPromise = e(1),
                ...
                o.pool = e(9),
                o.LongBits = e(34),
                o.isNode = !!(void 0 !== global && global && global.process && global.process.versions && global.process.versions.node),
                o.global = o.isNode && global || "undefined" != typeof window && window || "undefined" != typeof self && self || this,
        ...
        36: [function (e, t, n) {
            t.exports = function (e) {
                ...
                for (var o = 0; o < e.fieldsArray.length; ++o) {
                    var a, c = e.i[o].resolve(), l = "m" + r.safeProp(c.name);
                    c.optional && t("if(%s!=null&&m.hasOwnProperty(%j)){", l, c.name),
                        c.map ? (t("if(!util.isObject(%s))", l)("return%j", i(c, "object"))("var k=Object.keys(%s)", l)("for(var i=0;i<k.length;++i){"),
                            ...
                            s(t, c, o, l + "[k[i]]")("}")) : c.repeated ? (t("if(!Array.isArray(%s))", l)("return%j", i(c, "array"))("for(var i=0;i<%s.length;++i){", l),
                            s(t, c, o, l + "[i]")("}")) : (c.partOf && (a = r.safeProp(c.partOf.name),
                        1 === n[c.partOf.name] && t("if(p%s===1)", a)("return%j", c.partOf.name + ": multiple values"),
                            n[c.partOf.name] = 1,
                            t("p%s=1", a)),
                            s(t, c, o, l)),
                    c.optional && t("}")
        ...
        38: [function (e, t, n) {
            t.exports = d;
            var o, r = e(35), i = r.LongBits, s = r.base64, a = r.utf8;
            ...
            d.prototype.bytes = function (e) {
                var t, n = e.length >>> 0;
                return n ? (r.isString(e) && (t = d.alloc(n = s.length(e)),
                    s.decode(e, t, 0),
                    e = t),
                ...
                d.prototype.string = function (e) {
                    var t = a.length(e);
                    return t ? this.uint32(t).p(a.write, t, e) : this.p(p, 1, 0)
                }
                ,
...
function PolicyInfoByTypeIdParamEncode(m, w) {
    if (!w)
        w = write123.Writer.create()
...
function  Start(data){
    return PolicyInfoByTypeIdParamEncode(data).finish().slice()
}